...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/07/30 23:01:26 by akarasso          #+#    #+#             */
/*   Updated: 2018/07/31 00:15:33 by akarasso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		get_args(t_board *bd, t_process *proc, int *ocp, int *val)
{
